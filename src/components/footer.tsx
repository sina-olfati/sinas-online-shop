...
export function Footer () {
    ...
    return (
        ...
        <div className="bg-primary/30">
            ...
            <div about="main" className="flex items-end gap-20 p-16 pt-32">
                ...
                {lists.map((list, index) => 
                    <div key={index} className="w-[23%] h-full flex flex-col items-start justify-start">
            ...
            <div about="bottom" className="w-full pb-4 pt-4 flex justify-center items-center border border-t-accent/50 border-x-0 border-b-0 text-accent text-sm">
